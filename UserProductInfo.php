...
<body class="d-flex flex-column min-vh-100">
    ...
    <section id="product-info">
        <div class="container-fluid d-flex flex-row justify-content-between left-right-only-pad" style="height:100%">
            ...
            <div class="col col-sm-6 d-flex flex-column justify-content-center" id="info-col">
                <div class="row d-flex">
                   ...
                   echo "</div>";
                        ...
                        //             </div>";
                        // }
                    echo "<div style='border-top:2px solid green'>
                                <h4 style = ''> Price: $price €</h4>
                                    <h4> Stock: $stock</h4>
                                </div>";
                    ?>
                </div>

                <div class="row flex-row right-only-pad">
                        <?php
