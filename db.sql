...
('Konjac Rice', 2.36, 100, 'Crazy about rice? We''ve got the perfect product for you! Made from all-natural organic gluten-free Konjac flour and organic oat fibre, Slim Rice is a low-calorie alternative that helps you lose weight without compromising on taste.', 'sources/images/Konjac_rice.png', 2),
...
('Corn Cakes', 1.10, 100, 'Keep in a cool and dry place.', 'sources/images/Corn_cakes.png', 3),
...
('Dried Mulberries', 2.54, 100, 'Keep in a cool and dry place.', 'sources/images/Dried_mulberries.png', 3),
('Black Raisin', 1.99, 100, 'Keep in a cool and dry place.', 'sources/images/Black_raisin.png', 3),
('Olive soap', 1.58, 100, 'Pure, natural soap from olive oil, with salt and natural aroma.', 'sources/images/Olive_soap.png', 4),
('Lice shampoo', 13.70, 100, 'This shampoo contains neem oil, which soothes itching and sweet almond oil, which smoothes and gives a light shine to your hair.', 'sources/images/Lice_shampoo.png', 4),
...
('Strawberry jam', 4.97, 100, '', 'sources/images/Strawberry_jam.png', 6),
