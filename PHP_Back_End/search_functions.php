    ...
    echo "<div id='product1' class='container-fluid' style='padding: 0'>
                ...
                <div class='row'>
                    <div class='$name_col_width'>
                        <a href='$linkToEditProduct' style='font-size: 14px; word-break: break-word'>$name<br/>($stock left in stock)</a>
                    </div>
                                    ...
                                    <div class='modal-dialog modal-lg'>
                                        <div class='modal-content'>
                                            ...
                                            <div class='modal-header'>
                                                <h3 class='modal-title' style='padding-left: 1.5rem; word-break: break-word'>Delete \"$name\" from the database?</h3>
                                            ...
                                            <div class='modal-body'>
                                                <div class='container-fluid'>
                                                    <div class='row'>
                                                        <p style='margin: 0; word-break: break-word'>Are you sure you want to delete the product \"$name\" from the database? It's data will be lost forever.</p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class='modal fade' id='addToCartModal$id'>
                            <div class='modal-dialog modal-lg'>
                                <div class='modal-content'>
                                    ...
                                    <div class='modal-header'>
                                        <h3 class='modal-title' style='padding-left: 1.5rem; word-break: break-word'>Add \"$name\" to your cart</h3>
                                        <button type='button' style='padding-right: 1.5rem' class='btn-close' data-bs-dismiss='modal'></button>
                                    </div>
                                    ...
                                    <div class='modal-body'>
                                        <div class='container-fluid'>
                                            <div class='row'>
                                                <div class='col-6'>
                                                    <p class='text-lg'>Product name: <a href='$linkToProductInfo' style='word-break: break-word'>$name</a></p>
